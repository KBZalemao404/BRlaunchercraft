...
if (!(window as any).electronAPI) {
  ...
  ;(window as any).electronAPI = {
    ...
    exportDiagnostics: () => Promise.resolve(JSON.stringify({ version: '0.1.13', platform: 'mock' }, null, 2)),
