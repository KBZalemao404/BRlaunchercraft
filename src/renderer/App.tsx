...
export default function App() {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case 'ai': return <AIPage systemInfo={systemInfo} javaVersion={installedVersions[Object.keys(installedVersions)[0]]?.javaVersion} mcVersion={Object.keys(installedVersions)[0]} />
